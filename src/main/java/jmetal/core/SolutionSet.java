...
//      BufferedWriter bw      = new BufferedWriter(osw)        ;            
//
//      bw.write("Encryption Encryption_s2 ListenPort ListenPort_s2 DefaultCall_Protocol DefaultCall_Protocol_s2 "
//      		+ "DefaultTransport DefaultTransport_s2 Ice_DefaultCandidate MTU MTU_s2 DefaultCall_Rate DefaultCall_Rate_s2 "
//      		+ "MaxTransmitCallRate MaxReceiveCallRate MaxTransmitCallRate_s2 MaxReceiveCallRate_s2");
//      if (size()>0) {
...
//				bw.write("Off ");
//				}
//				if (aSolutionsList_.getDecisionVariables()[j].getValue()==1){
//				bw.write("On ");
//				}
//				else{
//				bw.write("BestEffort ");
...
//				}				
//			} 
//    		// Conference_DefaultCall_Protocol = new Int(0, 3);
//			else if (j == 4) {
//				if (aSolutionsList_.getDecisionVariables()[j].getValue()==0){
//				bw.write("Auto ");
//				}
...
//				bw.write("Sip ");
//				}
//				if (aSolutionsList_.getDecisionVariables()[j].getValue()==2){
//				bw.write("H323 ");
//				}
//				else{
//				bw.write("H320 ");
//				}				
//			}          
//  		// Conference_DefaultCall_Protocol_s2 = new Int(0, 2);
//			else if (j == 5) {
//				if (aSolutionsList_.getDecisionVariables()[j].getValue()==0||aSolutionsList_.getDecisionVariables()[j].getValue()==3){
//				bw.write("Sip ");
//				}
//				if (aSolutionsList_.getDecisionVariables()[j].getValue()==1){
//				bw.write("H323 ");
...
//				}				
//			}
//    		// Sip_DefaultTransport = new Int(0, 3) + Sip_DefaultTransport_s2 = new Int(0, 3);
//			else if (j == 6||j == 7) {
//				if (aSolutionsList_.getDecisionVariables()[j].getValue()==0){
//				bw.write("Auto ");
//				}
...
//				}				
//			}
//  		// Sip_Ice_DefaultCandidate = new Int(0, 2);
//			else if (j == 8) {
//				if (aSolutionsList_.getDecisionVariables()[j].getValue()==0){
//				bw.write("Host ");
//				}
